...
interface FGDataGridProps extends Omit<GridProps, 'size'> {
...
export const FGDataGrid: React.FC<FGDataGridProps> = ({
  ...
  return (
    <div className={`fg-datagrid ${className}`}>
      <Grid {...gridProps} style={gridStyles} className="fg-datagrid-grid">
        {children}
      </Grid>
      ...
      {!loading && (!gridProps.data || (gridProps.data as any[]).length === 0) && (
        <div
