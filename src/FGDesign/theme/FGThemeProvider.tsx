...
export const FGThemeProvider: React.FC<FGThemeProviderProps> = ({ children, theme }) => {
  ...
  return <FGThemeContext.Provider value={mergedTheme}>{children}</FGThemeContext.Provider>;
};
